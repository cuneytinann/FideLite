...
A full-FIDE chess arbiter in **1,876 bytes** of plain JavaScript — no dependencies, no install,
...
| --- | --- | --- |
| `builds/engine.js` | 1,876 | The rule engine. One line, no front end. |
| `builds/engine_4x.js` | 1,956 | The same rules, +80 bytes, two to ten times the speed. |
| `builds/engine_string.js` | 1,990 | The same rules on a board of FEN letters instead of numbers. |
...
Tam FIDE kurallı satranç hakem motoru, **1.876 bayt** saf JavaScript — bağımlılık yok, kurulum
...
| Dosya | Bayt | Ne |
| --- | --- | --- |
| `builds/engine.js` | 1.876 | Kural motoru. Tek satır, önyüz yok. |
| `builds/engine_4x.js` | 1.956 | Aynı kurallar, +80 bayt, iki ilâ on kat hız. |
| `builds/engine_string.js` | 1.990 | Aynı kurallar, tahta sayı yerine FEN harfleriyle. |
